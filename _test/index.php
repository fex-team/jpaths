...
<head>
    ...
    <title>JPaths Test Index Page</title>
    <script src="tools/js/jquery-1.5.1.js"></script>
    <script src="tools/js/testrunner.js"></script>
    <!--    <script src="_test/tools/js/ext_qunit.js"></script>-->
    <link rel="stylesheet" href="tools/css/qunit.css">
    <script type="text/javascript" src="tools/js/run.js"></script>

    <!--    <script type="text/javascript" src="js/log4js.js"></script>-->
    <link media="screen" href="tools/css/tangramtest.css" type="text/css"
          rel="stylesheet"/>
</head>
<body>
<div id="title">
    <h1>JPaths Test Index Page</h1>

    <p>
        <a href="https://github.com/fex-team/jpaths">JPaths</a>
    </p>
</div>
