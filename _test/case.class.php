...
//        }
    ...
    public function print_js( $cov, $release = false )
    {
        ...
        print '<script type="text/javascript" src="tools/js/jquery-1.5.1.js"></script>' . "\n";
        print '<script type="text/javascript" src="tools/js/testrunner.js"></script>' . "\n";
//        print '<script type="text/javascript" src="tools/js/ext_qunit.js"></script>' . "\n";
        print '<link media="screen" href="tools/css/qunit.css" type="text/css" rel="stylesheet" />' . "\n";
        print '<script type="text/javascript" src="../lib/require.js"></script>' . "\n";



        /* load case source*/
        print '<script type="text/javascript" src="case/'.$this->name.'.js"></script>' . "\n";
        $importurl = "import.php?f=$this->name";
...
//        print '<script type="text/javascript" src="lib/esl.js"></script>' . "\n";
    ...
    public static function listcase( $matcher = "*" , $projroot = '../' )
    {
        ...
        $testpath = $projroot . '_test/case/';
        require_once 'filehelper.php';
        $caselist = getSameFile( $testpath , $testpath , '' );//默认取src和test下的同名文件
        ...
        foreach ( $caselist as $caseitem ) {
            ...
            if ( $c->match( $matcher ) ) {
                ...
                print( "<a href=\"run.php?case=$name\" id=\"$c->case_id\" class=\"jsframe_qunit\" target=\"_blank\" title=\"$name\" onclick=\"run('$name');return false;\">"
